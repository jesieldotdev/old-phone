      ...
      <div className="flex-1 flex flex-col gap-1 mt-2 px-2 max-h-[180px] overflow-y-auto scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-blue-50">
        {contactsList.map((contact, idx) => (
          <div
            ...
            className={`text-lg px-2 py-1 rounded cursor-pointer transition flex items-center justify-between
          ...
          >
            <div className="flex items-center gap-2">
              {contact.favorite ? <Star className="h-4 text-yellow-600 fill-current" /> : <User className="h-4" />}
